...
public class ShootSafeZoneAutoCmd extends Command {
  /** Creates a new ShootSafeZone. */
    ...
    private static final double ANGLER_SHOOTER_TIME = 0.7;
    private boolean isShooterPrimed; // When true, start the indexer.

    private static final Timer TIMER = new Timer();


    public ShootSafeZoneAutoCmd(ShooterSubSys shooterSubSysObj, IndexerSubSys indexerSubSysObj, double tgtShooterVelRPM, ShooterAnglerSubSys shooterAnglerSubSysObj) {
